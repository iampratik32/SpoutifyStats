...
import com.gh0osty.spoutifystats.Adapters.Song_ArtistAdapter
...
class SongActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val data = ArrayList<Song_ArtistViewModel>()
        for (i in 1..2) {
            data.add(Song_ArtistViewModel("A${i}","Artist $i",R.drawable.spotify))
        }
        val adapter = Song_ArtistAdapter(data, this)
