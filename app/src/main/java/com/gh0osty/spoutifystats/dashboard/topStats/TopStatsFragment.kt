package com.gh0osty.spoutifystats.dashboard.topStats
...
import com.gh0osty.spoutifystats.dashboard.topStats.helper.TopStatsPagerAdapter
...
class TopStatsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewPager.adapter = TopStatsPagerAdapter(requireActivity())
        TabLayoutMediator(
            tabLayout,  viewPager
        ) { tab, position ->
